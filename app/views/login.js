...
export function loginView() {
  ...
  wrap.innerHTML = `
    <div class="login-hero">
      ...
      <h1>מהצורך לכלי</h1>
      <p class="login-lead">כאן לא לומדים לתכנת. כאן לוקחים צורך אמיתי מההוראה שלך —
        והופכים אותו, צעד אחר צעד, לכלי דיגיטלי קטן שעובד.</p>
  ...
  note.textContent = BACKEND === "firebase"
    ? "נשלח לך קישור כניסה למייל — בלי סיסמה לזכור."
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      else { note.classList.remove("err"); note.textContent = "שלחנו לך קישור כניסה למייל. פִּתחו אותו כדי להיכנס."; btn.textContent = "נשלח ✓"; }
    } catch (err) {
